...
public class BailoutMain {
    ...
    final public static int TEST_TIME = 60 * 1000;
    ...
    public static void main(String[] args) {
        ...
        for (Future<BailoutFuture> future : set) {
            ...
            System.out.println("Iterations per second on thread[" + counter++ + "] -> " + result.getIterationsPerSecond());
